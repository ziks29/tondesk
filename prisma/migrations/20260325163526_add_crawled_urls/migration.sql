...
INSERT INTO "new_Bot" ("aiModel", "botToken", "botUsername", "crawlMaxDepth", "crawlMaxPages", "createdAt", "id", "isActive", "knowledgeBaseText", "ownerWallet", "secretToken", "systemPrompt", "updatedAt", "webSearchEnabled", "welcomeMessage") SELECT "aiModel", "botToken", "botUsername", "crawlMaxDepth", "crawlMaxPages", "createdAt", "id", "isActive", "knowledgeBaseText", "ownerWallet", "secretToken", "systemPrompt", "updatedAt", "webSearchEnabled", "welcomeMessage" FROM "Bot";
DROP TABLE "Bot";
