...
export async function GET(request: Request) {
  try {
    ...
    // Parallelize independent database operations to reduce overall response time.
    // Both user upsert and bot count rely only on the walletAddress string,
    // so they do not depend on each other and can be executed concurrently safely.
