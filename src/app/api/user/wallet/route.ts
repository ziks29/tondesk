...
export async function GET(request: Request) {
  try {
    ...
    // ⚡ Bolt: Execute independent queries concurrently using Promise.all()
    // Expected impact: Reduces database I/O latency from sum(O_upsert, O_count) to max(O_upsert, O_count)
