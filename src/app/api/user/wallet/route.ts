...
export async function GET(request: Request) {
  try {
    ...
    // Instead of sequentially waiting for user.upsert and bot.count (~10-20ms each),
    // Promise.all executes them concurrently, cutting DB latency for this segment in half.
